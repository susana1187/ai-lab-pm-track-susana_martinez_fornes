...
- the reader I'm worried about: `<the skeptical reader you write for, examples: a skeptical engineering director (Foundation PM); a CSM about to push this to a customer (Solution PM); a design lead who tears apart unstated user assumptions (Designer); a GM who has to fund the bet>`
- the kinds of weakness to surface first: `<e.g., missing acceptance criteria, unstated assumptions, fuzzy timelines, vague user benefit>`
- the tone I want: direct, no padding, no hedging language
<!-- /ADAPT -->

## Prompt

Document to review: whatever the user typed after the slash command in this same message.
