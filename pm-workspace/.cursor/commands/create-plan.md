...
- mark each step as either "I do this" or "someone else does this" with a placeholder owner name when relevant
...
Question, decision, or initiative: whatever the user typed after the slash command in this same message.
